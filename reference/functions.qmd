...
emitCol <- function(lines, start, end) {
    ...
    lines <- gsub("\\|_\\|", "", lines)
    lines <- gsub("\\|incr\\|", "![](/static/img/cvxr_functions_img/increasing.png)", lines)
    lines <- gsub("\\|decr\\|", "![](/static/img/cvxr_functions_img/decreasing.png)", lines)
    lines <- gsub("\\|positive\\|", "![](/static/img/cvxr_functions_img/positive.png)", lines)
    lines <- gsub("\\|negative\\|", "![](/static/img/cvxr_functions_img/negative.png)", lines)
    lines <- gsub("\\|unknown\\|", "![](/static/img/cvxr_functions_img/unknown.png)", lines)
    lines <- gsub("\\|concave\\|", "![](/static/img/cvxr_functions_img/concave.png)", lines)
    lines <- gsub("\\|convex\\|", "![](/static/img/cvxr_functions_img/convex.png)", lines)
    lines <- gsub("\\|affine\\|", "![](/static/img/cvxr_functions_img/affine.png)", lines)
    lines <- gsub("\\`", "$", lines)
    ## Fix up pnorm
...
The output $X$ of `reshape_expr(X, c(m', n'))` is the matrix $X$ cast into an $m' \times n'$ matrix.
