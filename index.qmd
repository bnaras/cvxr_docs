...
d  <- tibble::tibble(
                  ...
                  `R package` = c('<a href="https://clarabel.org">clarabel</a>',
...
This site is built with [Quarto](https://quarto.org) and is
re-generated with every new release of `CVXR`. Many
[CVXPY](https://cvxpy.org) examples have been directly converted to
`CVXR`, serving both as tests of the package and as illustrations of
its use.
