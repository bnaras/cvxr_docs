...
the R implementation isomorphic with the released version of CVXPY
(currently 1.8.2). See [What's New in 1.8.x](whatsnew.qmd) for
details on the new API and migration guide.
:::
...
making `CVXR` isomorphic with the released version of CVXPY (currently 1.8.2) and adding support for DGP,
