...
if (params$mode == "save") {
    ...
    expect_equal(beta_ols, hub_results$beta_ols, tol = 1e-5)
    expect_equal(beta_prs, hub_results$beta_prs, tol = 1e-5)
    expect_equal(beta_hub, hub_results$beta_hub, tol = 1e-5)
}
```
