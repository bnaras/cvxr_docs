...
if (params$mode == "save") {
    ...
    expect_identical(w_cvxr, sc_results$w_cvxr)
    expect_identical(w_cvxr_q, sc_results$w_cvxr_q)
    expect_identical(w_cvxr_l, sc_results$w_cvxr_l)
    expect_identical(w_cvxr_h, sc_results$w_cvxr_h)
    expect_identical(w_cvxr_s, sc_results$w_cvxr_s)    
}
```
