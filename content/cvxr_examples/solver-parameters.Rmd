...
split between three times of parameters in `Doubl`, `Integer`, and
...
[R Markdown](https://github.com/bnaras/cvxr_docs/blob/master/content/cvxr_examples/solver_parameters.Rmd)
