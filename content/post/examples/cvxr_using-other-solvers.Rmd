...
- [SCS](https://github.com/cvxgrp/scs) via the CRAB package
...
[R Markdown](https://github.com/bnaras/cvxr_docs/blob/master/content/post/examples/cvxr_using-other-solvers.Rmd)
