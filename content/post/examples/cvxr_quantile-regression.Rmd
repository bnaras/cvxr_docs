...
Quantile regression is another variation on least squares is quantile regression
...
[R Markdown](https://github.com/bnaras/cvxr_docs/blob/master/content/post/examples/cvxr_quantile-regression.Rmd)
