...
objective <- Minimize(x^2 + y^2 + abs(x-y))
constraints <- c(constraints(prob2.1), y <= 1)
prob2.2 <- Problem(objective, constraints)
...
prob2.3 <- Problem(objective, constraints(prob2.1))
solve(prob2.3)
```
