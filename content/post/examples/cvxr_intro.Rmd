...
Given the data $X$ and $Y$, we can estimate $\beta$ using the `lm`
...
We also have a number of [tutorial examples](/post/examples/), which are
available to study and modify.
