...
This is the
famous [catenary problem](https://en.wikipedia.org/wiki/Catenary).
...
with variables $x \in {\mathbf R}^m$ and $y \in {\mathbf R}^m$. 

This basic catenary problem has a well-known analytical solution
