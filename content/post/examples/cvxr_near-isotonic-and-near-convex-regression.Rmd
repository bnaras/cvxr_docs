...
`differences` that 1 by default; a third-order difference is specified
...
[R Markdown](https://github.com/bnaras/cvxr_docs/blob/master/content/post/examples/cvxr_near-isotonic-and-near-convex-regression.Rmd)
