...
bootstrapping. In what follows, we use a very small number of
bootstrap samples as the fits are time consuming.
...
`differences` is by default 1; a third-order difference is specified
