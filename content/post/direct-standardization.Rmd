...
$1/m$ on each $y_i$ is not a good estimate. Instead, we must
determine the weights $w \in {\mathbf R}^m$ of a weighted empirical
distribution, $y = y_i$ with probability $w_i$, which rectifies the
skewness of the sample [@dirstd, 19.5]. We can pose this
problem as
