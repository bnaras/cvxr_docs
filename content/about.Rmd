...
[Github](https://github.com/cvxgrp/CVXR). The 1.0 version of `CVXR`
has now been released and now implements the reductions framework as
referenced [here](http://stanford.edu/~boyd/papers/cvxpy_rewriting.html). 
More details of all the changes can be seen [here](/cvxr_examples/whats_new_1.0/)
