...
Documentation](https://www.cvxgrp.org/CVXR). The current release
implements all of the `CVXPY` atoms except for `geo_mean` and
parameters. The latter is not an impediment since any parameter can be
replaced by a variable.

`CVXR` continues to be developed on
[Github](https://github.com/cvxgrp/CVXR).  The 1.0 branch of the repo
