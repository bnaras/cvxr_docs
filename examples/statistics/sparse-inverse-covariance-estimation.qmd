...
In the code above, the `PSD = TRUE` attribute restricts `S` to the
...
undefined for a PSD variable object.
...
if (params$mode == "save") {
    ...
    expect_equal(S.est[[1]], sice_result[[1]], tolerance = 1e-10)
    expect_equal(S.est[[2]], sice_result[[2]], tolerance = 1e-10)
    expect_equal(S.est[[3]], sice_result[[3]], tolerance = 1e-10)
    expect_equal(S.est[[4]], sice_result[[4]], tolerance = 1e-10)
    expect_equal(S.est[[5]], sice_result[[5]], tolerance = 1e-10)
}
```
