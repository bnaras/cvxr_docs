...
if (params$mode == "save") {
    ...
    expect_equal(result_l1, saved$objective_l1, tolerance = 1e-10)
    expect_equal(nnz_l1, saved$nnz_l1, tolerance = 1e-10)
}
```
...
if (params$mode == "save") {
    ...
    expect_equal(nnzs_log, saved$nnzs_log, tolerance = 1e-10)
}
```
