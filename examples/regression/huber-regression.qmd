...
if (params$mode == "save") {
    ...
    expect_equal(beta_ols, hub_results$beta_ols, tolerance = 1e-10)
    expect_equal(beta_prs, hub_results$beta_prs, tolerance = 1e-10)
    expect_equal(beta_hub, hub_results$beta_hub, tolerance = 1e-10)
}
```
