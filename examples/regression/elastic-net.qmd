...
knitr::kable(d, format = "html", escape = FALSE, caption = "Elastic net fits from `CVXR`", digits = 3) |>
...
knitr::kable(coef_net, format = "html", escape = FALSE, digits = 3, caption = "Coefficients from `glmnet`") |>
    kable_styling("striped") |>
    column_spec(1:11, background = "#ececec")
```
