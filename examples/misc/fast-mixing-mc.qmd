...
disp_result <- function(states, P, tolerance = 1e-10) {
...
if (params$mode == "save") {
    ...
    expect_equal(result1, fmix$result1, tolerance = 1e-10) # small errors ok
    expect_equal(result2, fmix$result2, tolerance = 1e-10)
    expect_equal(result3, fmix$result3, tolerance = 1e-10)
    expect_equal(result4, fmix$result4, tolerance = 1e-10)
}
```
